...
describe('Room', () => {
  ...
  it('give array with length of room sleeps number (min 0, max 2)', () => {
    expect(new Room('', -1, 0, '').sleepsNumberArray().length).toEqual(0);
    expect(new Room('', 0, 0, '').sleepsNumberArray().length).toEqual(0);
    expect(new Room('', 1, 0, '').sleepsNumberArray().length).toEqual(1);
    expect(new Room('', 2, 0, '').sleepsNumberArray().length).toEqual(2);
    expect(new Room('', 3, 0, '').sleepsNumberArray().length).toEqual(2);
  });
