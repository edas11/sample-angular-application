...
export class HotelsData {
    ...
    static getHotelsData(cs: CitiesService): Hotel[] {
        ...
        hotels.push(new Hotel('Radisson Blu Hotel Lietuva', 'Konstitucijos pr. 20, Snipiskes', cs.getCity('Vilnius'),
            ...
            [new Room('Standard Room', 2, 129, 'assets/rooms/radisson-standard-room.jpg'),
             new Room('Superior Room', 2, 135, 'assets/rooms/radisson-superior-room.jpg')],
        ...
        hotels.push(new Hotel('Hotel Zemaites', 'Zemaites g. 15, Vilkpede', cs.getCity('Vilnius'),
            ...
            [new Room('Twin room', 2, 48.60, 'assets/rooms/zemaites-twin.jpg'),
             new Room('Deluxe Double Room', 2, 80, 'assets/rooms/zemaites-deluxe.jpg')],
        ...
        hotels.push(new Hotel('The Langham London', 'Portland Place, Westminster Borough', cs.getCity('London'),
            ...
            [new Room('Superior Double Room', 2, 632, 'assets/rooms/langham-double.jpg'),
             new Room('Superior Twin Room', 2, 632, 'assets/rooms/langham-twin.jpg')],
        ...
        hotels.push(new Hotel('The Landmark London', '222 Marylebone Road, Westminster Borough', cs.getCity('London'),
            ...
            ['Parking', 'Food and drink', 'Free WiFi', 'Non-smoking Rooms'], ['Bar', 'Swimming pool', 'Fitness Centre', 'Spa'],
            [new Room('Double Room', 2, 292, 'assets/rooms/landmark-double.jpg'),
             new Room('Executive Double Room', 2, 364, 'assets/rooms/landmark-executive.jpg')],
        ...
        hotels.push(new Hotel('Mondrian London', '20 Upper Ground, Southwark', cs.getCity('London'),
            ...
            [new Room('Standard Room', 2, 221, 'assets/rooms/mondrian-standard.jpg'),
             new Room('Superior Room', 2, 322, 'assets/rooms/mondrian-superior.jpg')],
        ...
        hotels.push(new Hotel('Hotel Excelsior Latin', '20 rue Cujas, 5th arr.', cs.getCity('Paris'),
            ...
            [new Room('Classic Double Room', 2, 158, 'assets/rooms/excelsior-double.jpg'),
             new Room('Classic Twin Room', 2, 168, 'assets/rooms/excelsior-twin.jpg')],
        ...
        hotels.push(new Hotel('Hotel Regina Louvre', '2 place des Pyramides, 1st arr,', cs.getCity('Paris'),
            ...
            [new Room('Deluxe Double Room', 2, 540, 'assets/rooms/regina-double.jpg'),
             new Room('Prestige Suite', 2, 855, 'assets/rooms/regina-suite.jpg')],
        ...
        hotels.push(new Hotel('La Clef Tour Eiffel', '83 avenue Kléber, 16th arr.,', cs.getCity('Paris'),
            ...
            [new Room('Classic Double or Twin Room', 2, 390, 'assets/rooms/la-clef-tour-double.jpg'),
             new Room('Executive Studio', 2, 446, 'assets/rooms/la-clef-tour-studio.jpg')],
        ...
        hotels.push(new Hotel('Leonardo Royal Hotel Berlin Alexanderplatz', 'Otto-Braun-Str. 90, Friedrichshain-Kreuzberg', cs.getCity('Berlin'),
            ...
            [new Room('Classic Double Room', 2, 89.10, 'assets/rooms/leonardo-double.jpg'),
             new Room('Junior Suite', 2, 149, 'assets/rooms/leonardo-suite.jpg')],
        ...
        hotels.push(new Hotel('H4 Hotel Berlin Alexanderplatz', 'Karl-Liebknecht-Strasse 32, Mitte', cs.getCity('Berlin'),
            ...
            ['Parking', 'Food and drink', 'Free WiFi', 'Non-smoking Rooms'], ['Bar', 'Cycling', 'Fitness Centre', 'Spa'],
            [new Room('Comfort Double or Twin Room', 2, 96.05, 'assets/rooms/h4-double.jpg'),
             new Room('Suite', 2, 181.05, 'assets/rooms/h4-suite.jpg')],
